...
However in the initial stage of requirements engineering, a somewhat spiral view of the development process is used. The spiral view can be seen on \myref{fig:spiralDiagram}.
